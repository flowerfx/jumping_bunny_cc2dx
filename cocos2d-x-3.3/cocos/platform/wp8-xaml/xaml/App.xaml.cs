...
namespace cocos2d
{
    public partial class App : Application
    {
        ...
        private void SetupMockIAP()
        {
            ...
            MockIAP.AddProductListing("_bunny_small_pack", p);

            p = new ProductListing
            {
                Name = "Medium Pack",
                //ImageUri = new Uri("/Res/Image/2.png", UriKind.Relative),
                ProductId = "_bunny_medium_pack",
                ProductType = Windows.ApplicationModel.Store.ProductType.Consumable,
                Keywords = new string[] { "image" },
                Description = "Nice image",
                FormattedPrice = "2.99$",
            ...
            MockIAP.AddProductListing("_bunny_medium_pack", p);

            p = new ProductListing
            {
                Name = "Mega Pack",
                //ImageUri = new Uri("/Res/Image/3.png", UriKind.Relative),
                ProductId = "_bunny_mega_pack",
                ProductType = Windows.ApplicationModel.Store.ProductType.Consumable,
                Keywords = new string[] { "image" },
                Description = "Nice image",
                FormattedPrice = "4.99$",
            ...
            MockIAP.AddProductListing("_bunny_mega_pack", p);

            p = new ProductListing
            {
                Name = "Remove Ads",
                //ImageUri = new Uri("/Res/Image/3.png", UriKind.Relative),
                ProductId = "_bunny_remove_ads",
            ...
            MockIAP.AddProductListing("_bunny_remove_ads", p);

          
#endif
        }

        public void AddItemToMockLib(ProductListing p, string key)
        {
#if DEBUG
        ...
        private void ClearBackStackAfterReset(object sender, NavigationEventArgs e)
        {
            ...
            if (e.NavigationMode != NavigationMode.New || e.Uri.OriginalString.Contains(CCFacebookUtils.FacebookClient.ProductID))
                return;
